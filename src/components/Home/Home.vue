<template>
<p class="font-medium text-2xl ml-5 my-3">Dashboard</p>
<div class="bg-purple-700 p-3 rounded-lg border mx-auto shadow-lg mt-4 w-[95%] flex items-center">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
        <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z" />
    </svg>
    <p class="ml-2 font-medium">Bản quyền thuộc <a href="https://github.com/LastMemoryStudio/" class="text-blue-300">Memory Platform</a></p>
</div>

<div class="grid grid-cols-1 md:grid-cols-3 md gap-2 mt-6">

    <div class="bg-white p-6 rounded-lg shadow-lg mx-auto w-[18em]">
        <h2 class="flex text-2xl font-bold mb-2 justify-items-center items-center mx-auto text-gray-800">
        ...
        <p class="text-gray-700">Số tiền trên website</p>
    </div>

    <div class="bg-white p-6 rounded-lg shadow-lg mx-auto w-[18em]">
        <h2 class="flex text-2xl font-bold mb-2 justify-items-center items-center mx-auto text-gray-800">
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="36" fill="currentColor" class="bi bi-reception-4" viewBox="0 0 16 16">
                <path d="M0 11.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-2zm4-3a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-5zm4-3a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v8a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-8zm4-3a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v11a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-11z" />
            </svg>
            150
        </h2>
        <p class="text-gray-700">Số người đang online</p>
    </div>

    <div class="bg-white p-6 rounded-lg shadow-lg mx-auto w-[18em]">
        <h2 class="flex text-2xl font-bold mb-2 justify-items-center items-center mx-auto text-gray-800">
            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-kanban-fill" viewBox="0 0 16 16">
        ...
        <p class="text-gray-700">Dự án đã viết</p>
    </div>
</div>
